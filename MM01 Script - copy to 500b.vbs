...
Set ExcelWorkbook = ExcelApp.Workbooks.Open("D:\ScriptData\Material Master copy for Plant 500B.xlsx")
...
On Error Resume next
	If session.findById("wnd[2]/usr/txtMESSTXT1").text="Material already maintained for this" Then
...
session.findById("wnd[0]").sendVKey 0
ExcelSheet.Cells(Row,38).Value = Session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP13/ssubTABFRA1:SAPLMGMM:2000/subSUB3:SAPLMGD1:2485/txtMARC-PLIFZ").text
ExcelSheet.Cells(Row,39).Value = Session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP13/ssubTABFRA1:SAPLMGMM:2000/subSUB3:SAPLMGD1:2485/txtMARC-DZEIT").text
...
session.findById("wnd[0]").sendVKey 0
session.findById("wnd[0]").sendVKey 0
ExcelSheet.Cells(Row,40).Value = session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP24/ssubTABFRA1:SAPLMGMM:2000/subSUB2:SAPLMGD1:2800/subSUB2:SAPLMGD1:2802/txtMBEW-VERPR").text
ExcelSheet.Cells(Row,41).Value = session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP24/ssubTABFRA1:SAPLMGMM:2000/subSUB2:SAPLMGD1:2800/subSUB2:SAPLMGD1:2802/txtMBEW-STPRS").text
...
session.findById("wnd[1]").sendVKey 0
On Error Resume next
ExcelSheet.Cells(Row,44).Value=session.findById("wnd[2]/usr/txtMESSTXT1").text
If ExcelSheet.Cells(Row,44).Value="Material already maintained for this" Then
		Session.findById("wnd[2]/tbar[0]/btn[0]").press
		Session.findById("wnd[1]/tbar[0]/btn[12]").press
		row=row+1
		Call mysub
