Dim file,ExcelApp,ExcelWorkbook,ExcelSheet,Row,errcheck1
...
session.findById("wnd[1]/tbar[0]/btn[0]").press
errcheck1=session.findbyid("wnd[2]").text
If errcheck1="Error" Then
...
session.findbyid("wnd[0]/usr/tabsTABSPR1/tabpSP12/ssubTABFRA1:SAPLMGMM:2000/subSUB2:SAPLMGD1:2481/ctxtMARC-EKGRP").text=ExcelSheet.Cells(Row,5).Value
'session.findById("wnd[0]").sendVKey 0
