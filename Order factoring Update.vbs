...
Dim messtxt,z,Row,WshShell,File,strStatus,strWndName,stat2
...
Session.findbyid("wnd[1]/tbar[0]/btn[0]").press
	...
	session.findById("wnd[0]/usr/tabsTAXI_TABSTRIP_HEAD/tabpT\13/ssubSUBSCREEN_BODY:SAPMV45A:4312/sub8309:SAPMV45A:8309/tabsZSD_ADDL_B_HEAD/tabpZSD_ADDL_B_HEAD_FC1/ssubZSD_ADDL_B_HEAD_SCA:ZSD_ADDL_DATA_B:8309/ctxtVBAK-ZZ_FACTOR").text = "ea" 
	session.findById("wnd[0]").sendVKey 0
	Session.findById("wnd[0]/tbar[0]/btn[11]").press
	stat2 = Session.findbyid("wnd[0]/sbar").text
	If stat2 <>"" Then
		ExcelSheet.Cells(Row,2).Value = stat2
		stat2=""
		Exit Sub
	End If
strWndName = Session.findbyid("wnd[1]").text
...
Sub NoDoc
	Session.findById("wnd[0]/tbar[0]/btn[11]").press
	ExcelSheet.Cells(Row,2).Value ="No Follow on documents - cancelled"
End Sub
