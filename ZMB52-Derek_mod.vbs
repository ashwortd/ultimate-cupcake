...
sub main
	...
	'**** search window is missing after variant changes, must select line item instead
'	session.findById("wnd[1]/usr/txtENAME-LOW").text = "rbelfort" 
	...
	session.findById("wnd[0]").sendVKey 0
	'next line not needed without variant search screen
