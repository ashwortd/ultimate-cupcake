...
session.findById("wnd[1]/usr/tblSAPLMGMMTC_VIEW").getAbsoluteRow(20).selected = false
...
session.findById("wnd[1]/usr/tblSAPLMGMMTC_VIEW").getAbsoluteRow(25).selected = false
session.findById("wnd[1]/tbar[0]/btn[0]").press
