'***************************************************************************
'	Purpose: Remove Material Master Storage Location information via MM02
'			(SLoc MRP Indicator, SpecialProcurementType(SPT), ROP, and ROQ)
'
'	Input: Excel file (\\WinFile02\data\CustSvc\Parts\Inventory\PMx Scripts\SLoc Info - Remove via MM02_data.xlsx)
'		A		Material
'		B		Plant
'		C		Storage Location
'		D		MRP Indicator
'		E		Special Procurement Type
'		F		ROP
'		G		ROQ
'		H		Status Message
'
...
'				DISKZ - SLoc MRP Indicator
'				LSOBS - Spec.proc.type: SLoc
'				LMINB - Reorder Point
'				LBSTF - Replenishment qty
'
...
Set ExcelWorkbook = ExcelApp.Workbooks.Open("\\WinFile02\data\CustSvc\Parts\Inventory\PMx Scripts\SLoc Info - Remove via MM02_data.xlsx")
...
Do Until ExcelSheet.Cells(Row,1).Value = ""
	...
	'session.findById("wnd[1]/usr/tblSAPLMGMMTC_VIEW/txtMSICHTAUSW-DYTXT[0,11]").setFocus 	'Select MRP4 view from SELECT VIEW screen
	...
	Else				
		...
		session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP15/ssubTABFRA1:SAPLMGMM:2000/subSUB6:SAPLMGD1:2498/ctxtMARD-DISKZ").text = ""
		session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP15/ssubTABFRA1:SAPLMGMM:2000/subSUB6:SAPLMGD1:2498/ctxtMARD-LSOBS").text = ""
		session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP15/ssubTABFRA1:SAPLMGMM:2000/subSUB6:SAPLMGD1:2498/txtMARD-LMINB").text = ""
		session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP15/ssubTABFRA1:SAPLMGMM:2000/subSUB6:SAPLMGD1:2498/txtMARD-LBSTF").text = ""
