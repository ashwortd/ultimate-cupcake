...
' Edit Date:	01/30/2015
Option Explicit

' File Definitions
Const fileName = "ZSD_BACKLOG_Export"
Const fileDirectory = "C:\Users\dma02\Desktop"
...
sub main
	...
	' Open Transaction
	session.StartTransaction("zsd_backlog")
' *** Commented out and replaced, when a new variant is added the required one moves position and provides wrong data ***
...
' *** New section added by dma02 8/6/2015
	session.findbyid("wnd[0]/tbar[1]/btn[17]").press
	session.findbyid("wnd[1]/usr/txtV-LOW").text = "Orders+quotes"
